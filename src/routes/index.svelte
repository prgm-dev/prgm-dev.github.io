...
<div class="dark" role="presentation">
	...
	<div
		role="banner"
		class="w-full sticky top-0 h-20 px-4 py-2 bg-dark {scrollY <= 0
			? 'shadow-none'
	...
	<main class="z-0">
		...
		>
			<div class="w-full xs:w-11/12 sm:w-10/12 flex flex-col space-y-8 px-5">
				...
				<p id="slogan-description" class="text-sm sm:text-base">
					We are committed to producing excellent quality interactive software.
					We specialise in developing real time solutions for real world
		...
		>
			...
			>
				...
				<SkillCard>
					...
					We have built multiple products, with our own funds and from the
					ground up, learning product design, testing and evaluation. We have a
					deep understanding of product design, and how to make our products
		...
		<section class="mx-auto w-full max-w-screen-md my-5 px-4 md:px-5 z-0">
			<h2 class="text-3xl font-rounded ml-5 mb-2">Our ventures</h2>
	...
	<footer class="mt-20 pb-10 opacity-25 w-full">
		<div
